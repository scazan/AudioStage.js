...
SoundPlayer.prototype = {
	...
	play: function(callbackHasStopped) {
	...
	changeConvolverVolume: function(value) {
		this.gainNodeConvolver.gain.value = value;
	},
	changeFilterFreq: function(value) {
		this.biQuad.frequency.value = value;
	},
	changeFilterQ: function(value) {
		this.biQuad.Q.value = value;
	},
	setCrossfadeStyle: function(value) {
		this.crossfadeStyle = value;
	},
	setCrossFade: function(val) {
	...
	setConvolveBuffer: function(buffer) {
		this.convolveBuffer = buffer;
	},
	addEffects: function(effectNames) {
